...
{
public:
    EventsPublisher(std::ostream& a_logStream ,size_t a_numOfThreads = 1);
...
private:
    ...
    {
    public:
        NotifyAct(PtrEvent a_eventPtr, PtrEventAgentsMap a_eventAgentsMapPtr, PtrProxy a_proxyPtr, PtrThreadsPool a_threadsPool, std::ostream& a_logStream);
